...
<title>Editing Ninja: <c:out value="${ninja.firstName}"/> <c:out value="${ninja.lastName}"/></title>
</head>
<body>
	<div class="editCont">
		<h1>Editing <c:out value="${ninja.firstName} ${ninja.lastName}"/></h1>
		<form:form action="/ninjas/${ninja.id}" method="post" modelAttribute="ninja" class="ninjaForm">
